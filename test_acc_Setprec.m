...
%       ACCURACY: set_prec
%
%   Compare top 25 and top 100 ranked nodes as sets vs network size
%
...
for network_id=1:15
    ...
    for trial_number=1:trials
       ...
       %    5 - SET100
        ...
        [~,st] = sort(x, 'descend'); % SET25,SET100_gex
        record(network_id,4,trial_number) = setoverlap(s(1:25),st(1:25));
        record(network_id,5,trial_number) = setoverlap(s(1:100),st(1:100));
       ...
       %    8 - SET100
        ...
        [~,st] = sort(x, 'descend'); % SET25,SET100_expv
        record(network_id,7,trial_number) = setoverlap(s(1:25),st(1:25));
        record(network_id,8,trial_number) = setoverlap(s(1:100),st(1:100));
       ...
       %    11 - SET100
        ...
        [~,st] = sort(x, 'descend'); % SET25,SET100_mexpv
        record(network_id,10,trial_number) = setoverlap(s(1:25),st(1:25));
        record(network_id,11,trial_number) = setoverlap(s(1:100),st(1:100));
