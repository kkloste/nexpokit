...
fprintf('\n ave error = expmv \t expm_tay \t gexpmq \t hpexpm \t expm_svec \n');
...
alg_num = 2;
%fprintf('\n alg_num = %i \t trial = %i',alg_num, trial);
    tic; [y svpush] = expm_tay_mex(P,ind,tol,t,maxnnz); time_vals(trial,alg_num) = toc;
...
%fprintf('\n\n alg names = expmv \t gsqres \t gexpmq \t gexpm_hash \t expm_svec ');
fprintf('\n\n alg names = expmv \t expm_tay \t gexpmq \t hpexpm \t expm_svec ');
